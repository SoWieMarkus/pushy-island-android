...
let ALL_TERRAIN = [FLOWER_RED_PRESSURE_PLATE, FLOWER_PRESSURE_PLATE, COCONUT_TUNNEL, COCONUT_TUNNEL_FINISH, WATER_INVISIBLE,WATER_INVISIBLE_PRESSURE, ICE, ITEM_TELEPORTER, BUOY, BOAT, SPIKES_PRESSURE_PLATE, TELEPORTER, SPIKES, HOLE, WATER_WITH_BOX, SAND_WITH_WATER, SPRING, BOMB_FIELD, STATUE_GOAL_RED, STATUE_GOAL_BLUE, STATUE_GOAL_GREEN, FARM_WITH_SEED, SAND_WITH_FARM, WATER, SAND, GRASS, GRASS_TOP_LEFT, GRASS_TOP_RIGHT, GRASS_BOTTOM_LEFT, GRASS_BOTTOM_RIGHT, SAND_TOP_LEFT, SAND_TOP_RIGHT, SAND_BOTTOM_LEFT, SAND_BOTTOM_RIGHT,];
let ALL_ENTITIES = [FLOWER_RED, COCONUT, PEARL, FLOWER,SHELL, TOWER, COUNT_HIDDEN, COUNT_ONE,  COUNT_TWO, COUNT_THREE, COUNT_FOUR, COUNT_FIVE, KEY, CHEST, PIRATE, PIRATE_HUT, LEAF_DOWN, LEAF_UP, LEAF_LEFT, LEAF_RIGHT, SHOT, SLING_SHOT, STATUE_RED, CRAB_MOTHER, BOMB, STATUE_GREEN, STATUE_BLUE, WATER_BOTTLE, BOTTLE, PUSHY, SEED, BOX, FINISH, TREE, STONE, CRAB_BABY, SEASTAR, COIN, NO_ENTITY];
