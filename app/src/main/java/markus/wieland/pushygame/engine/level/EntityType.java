...
public enum EntityType implements Type {
    ...
    @SerializedName("sea_star") SEA_STAR(6, R.drawable.seastar, 7),
    ...
    @SerializedName("pirate") PIRATE(22, R.drawable.pirat, 1, 44),
    @SerializedName("pirate_hut") PIRATE_HUT(23, R.drawable.pirat_hut, 1, 44),
    ...
    @SerializedName("flower_yellow") FLOWER_YELLOW(37, R.drawable.flower, 105),
